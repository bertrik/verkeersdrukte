...
public final class VerkeersDrukteApp extends Application<VerkeersDrukteAppConfig> {
    ...
    public void run(VerkeersDrukteAppConfig configuration, Environment environment) {
        ...
        ScheduledExecutorService executor = environment.lifecycle().scheduledExecutorService("traffic-%d").build();
        ...
        environment.healthChecks().register("traffic", new VerkeersDrukteHealthCheck(ndwHandler));
